const renderProductosCarrito = () => {
    ...
    if (totalCarrito() > 0) {    
        ...
        <tbody>
        <tr>
        <td colspan="5" class="text-end"><a href="#" class="btn btn-warning" onClick="vaciarCarrito()">Vaciar Carrito <img src="images/trash3.svg" alt="Vaciar Carrito" width="16" /></a></td>
        </tr>`;
